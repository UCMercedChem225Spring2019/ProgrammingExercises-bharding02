...
!     files are opened and read, they are closed and the matrices printed. Finally, 
!     the matrix product of these two matrices is formed using the f90 intrinsic 
!     function MatMul. This final matrix is also printed.
!
!     H. P. Hratchian, 2019.
!
      implicit none
